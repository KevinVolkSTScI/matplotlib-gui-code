...
#                print(xmin, xmax, ymin, ymax)
    ...
    def add_set(self, xvalues, yvalues, xlowerror=None, xhigherror=None,
        ...
        self.set_properties[self.nsets]['xmin'] = xmin
        self.set_properties[self.nsets]['xmax'] = xmax
        self.set_properties[self.nsets]['ymin'] = ymin
        self.set_properties[self.nsets]['ymax'] = ymax
    ...
    def make_plot_layout(self, nx1, ny1, n1):
        ...
        if (nx1 != self.nxplots) | (ny1 != self.nyplots):
            ...
            for loop in range(self.number_of_plots):
                try:
                    value = self.xparameters[loop]['minimum']
